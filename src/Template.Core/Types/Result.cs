...
public static class Result
{
    ...
    //public static Result<TResult> Continue<TValue, TResult>( this Result<TValue> result, Func<TValue, Option<TResult>> onSuccess, Func<Error, Option<TResult>>? onError = null )
    //    where TValue : notnull
    //    where TResult : notnull
    //    => result.Match(
    //        onSuccess: ( value ) => onSuccess(value).Match,
